...
!function(e, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof exports ? exports["sounds-api"] = n() : e["sounds-api"] = n()
}(self, (function() {
    return ( () => {
        var e = {
            766: (e, n, o) => {
                ...
                !function() {
                    ...
                    i.prototype = {
                            ...
                            if ("number" == typeof e)
                                ...
                                !o._playLock)) {
                                    for (var r = 0, i = 0; i < o._sounds.length; i++)
                                        o._sounds[i]._paused && !o._sounds[i]._ended && (r++,
                                        t = o._sounds[i]._id);
                                    1 === r ? e = null : t = null
                                }
                            }
                            ...
                            if (!(s >= p)) {
                                ...
                                if (o._webAudio) {
                                    var v = function() {
                                        ...
                                        void 0 === m.bufferSource.start ? u._loop ? m.bufferSource.noteGrainOn(0, s, 86400) : m.bufferSource.noteGrainOn(0, s, l) : u._loop ? m.bufferSource.start(0, s, 86400) : m.bufferSource.start(0, s, l),
                                    ...
                                    "running" === a.state && "interrupted" !== a.ctx.state ? v() : (o._playLock = !0,
                                    o.once("resume", v),
                                    o._clearTimer(u._id))
                                } else {
                                    var h = function() {
                                        ...
                                        try {
                                            var t = m.play();
                                            if (t && "undefined" != typeof Promise && (t instanceof Promise || "function" == typeof t.then) ? (o._playLock = !0,
                                            f(),
                                            t.then((function() {
                                                o._playLock = !1,
                                                m._unlocked = !0,
                                                n ? o._loadQueue() : o._emit("play", u._id)
                                            }
                                            )).catch((function() {
                                                o._playLock = !1,
                                                o._emit("playerror", u._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction."),
                                                u._ended = !0,
                                                u._paused = !0
                                            }
                                            ))) : n || (o._playLock = !1,
                                            ...
                                            m.playbackRate = u._rate,
                                            m.paused)
                                                return void o._emit("playerror", u._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
                                    ...
                                    "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" === m.src && (m.src = o._src,
                                    m.load());
                        ...
                        mute: function(e, n) {
                            ...
                            for (var t = o._getSoundIds(n), r = 0; r < t.length; r++) {
                                ...
                                o._webAudio && i._node ? i._node.gain.setValueAtTime(e ? 0 : i._volume, a.ctx.currentTime) : i._node && (i._node.muted = !!a._muted || e),
                                o._emit("mute", i._id))
                            }
                            return o
                        },
                        volume: function() {
                            ...
                            if (1 === r.length || 2 === r.length && void 0 === r[1]) {
                                ...
                                n = parseInt(r[1], 10));
                            if (!(void 0 !== e && e >= 0 && e <= 1))
                                return (o = n ? t._soundById(n) : t._sounds[0]) ? o._volume : 0;
                            if ("loaded" !== t._state || t._playLock)
                                ...
                                t;
                            void 0 === n && (t._volume = e),
                            n = t._getSoundIds(n);
                            for (var d = 0; d < n.length; d++)
                                (o = t._soundById(n[d])) && (o._volume = e,
                                r[2] || t._stopFade(n[d]),
                                t._webAudio && o._node && !o._muted ? o._node.gain.setValueAtTime(e, a.ctx.currentTime) : o._node && !o._muted && (o._node.volume = e * a.volume()),
                        ...
                        _stopFade: function(e) {
                            var n = this
                              , o = n._soundById(e);
                            return o && o._interval && (n._webAudio && o._node.gain.cancelScheduledValues(a.ctx.currentTime),
                        ...
                        rate: function() {
                            ...
                            if (0 === r.length)
                                ...
                                n = parseInt(r[1], 10));
                            if ("number" != typeof e)
                                return (o = t._soundById(n)) ? o._rate : t._rate;
                            if ("loaded" !== t._state || t._playLock)
                                return t._queue.push({
                                    event: "rate",
                                    action: function() {
                            ...
                            for (var d = 0; d < n.length; d++)
                                if (o = t._soundById(n[d])) {
                                    t.playing(n[d]) && (o._rateSeek = t.seek(n[d]),
                                    o._playStart = t._webAudio ? a.ctx.currentTime : o._playStart),
                                    o._rate = e,
                                    t._webAudio && o._node && o._node.bufferSource ? o._node.bufferSource.playbackRate.setValueAtTime(e, a.ctx.currentTime) : o._node && (o._node.playbackRate = e);
                                    var s = t.seek(n[d])
                                      , l = (t._sprite[o._sprite][0] + t._sprite[o._sprite][1]) / 1e3 - s
                                      , _ = 1e3 * l / Math.abs(o._rate);
                                    !t._endTimers[n[d]] && o._paused || (t._clearTimer(n[d]),
                                    t._endTimers[n[d]] = setTimeout(t._ended.bind(t, o), _)),
                                    t._emit("rate", o._id)
                                }
                            return t
                        },
                        seek: function() {
                            ...
                            if (0 === t.length)
                                ...
                                var r = o._getSoundIds()
                                  , i = r.indexOf(t[0]);
                                i >= 0 ? n = parseInt(t[0], 10) : o._sounds.length && (n = o._sounds[0]._id,
                                e = parseFloat(t[0]))
                            } else
                                2 === t.length && (e = parseFloat(t[0]),
                                n = parseInt(t[1], 10));
                            if (void 0 === n)
                                return 0;
                        ...
                        _ended: function(e) {
                            ...
                            !n._webAudio && t && n.stop(e._id, !0).play(e._id),
                            n._webAudio && t) {
                                n._emit("play", e._id),
                                e._seek = e._start || 0,
                                e._rateSeek = 0,
                            ...
                            return n._webAudio && !t && (e._paused = !0,
                            e._ended = !0,
                            e._seek = e._start || 0,
                            e._rateSeek = 0,
                            n._clearTimer(e._id),
                    ...
                    var d = {}
                      , s = function(e) {
                        ...
                        if (/^data:[^;]+;base64,/.test(n)) {
                            for (var o = atob(n.split(",")[1]), t = new Uint8Array(o.length), r = 0; r < o.length; ++r)
                                t[r] = o.charCodeAt(r);
                            _(t.buffer, e)
                        } else {
                            ...
                            a.onload = function() {
                                var n = (a.status + "")[0];
                                "0" === n || "2" === n || "3" === n ? _(a.response, e) : e._emit("loaderror", null, "Failed loading audio file with status: " + a.status + ".")
                            }
                            ,
                            a.onerror = function() {
                      ...
                      , _ = function(e, n) {
                        ...
                        "undefined" != typeof Promise && 1 === a.ctx.decodeAudioData.length ? a.ctx.decodeAudioData(e).then(t).catch(o) : a.ctx.decodeAudioData(e, t, o)
                    }
                      , c = function(e, n) {
                    ...
                    n.Howler = a,
                    n.Howl = i,
                    void 0 !== o.g ? (o.g.HowlerGlobal = r,
                    o.g.Howler = a,
                    o.g.Howl = i,
                    o.g.Sound = u) : "undefined" != typeof window && (window.HowlerGlobal = r,
                    window.Howler = a,
                    window.Howl = i,
                    window.Sound = u)
                }(),
                function() {
                    ...
                    HowlerGlobal.prototype.pos = function(e, n, o) {
                        ...
                        void 0 !== t.ctx.listener.positionX ? (t.ctx.listener.positionX.setTargetAtTime(t._pos[0], Howler.ctx.currentTime, .1),
                    ...
                    HowlerGlobal.prototype.orientation = function(e, n, o, t, r, a) {
                        ...
                        i.ctx.listener.forwardZ.setTargetAtTime(o, Howler.ctx.currentTime, .1),
                        i.ctx.listener.upX.setTargetAtTime(t, Howler.ctx.currentTime, .1),
                        i.ctx.listener.upY.setTargetAtTime(r, Howler.ctx.currentTime, .1),
                        i.ctx.listener.upZ.setTargetAtTime(a, Howler.ctx.currentTime, .1)) : i.ctx.listener.setOrientation(e, n, o, t, r, a),
                        i)
                    }
                    ,
                    ...
                    Howl.prototype.stereo = function(e, o) {
                        ...
                        for (var a = t._getSoundIds(o), i = 0; i < a.length; i++) {
                            ...
                            if (u) {
                                ...
                                "spatial" === r ? void 0 !== u._panner.positionX ? (u._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                    ...
                    Howl.prototype.pos = function(e, o, t, r) {
                        ...
                        for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                            ...
                            if (d) {
                                ...
                                void 0 !== d._panner.positionX ? (d._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                                d._panner.positionY.setValueAtTime(o, Howler.ctx.currentTime),
                                d._panner.positionZ.setValueAtTime(t, Howler.ctx.currentTime)) : d._panner.setPosition(e, o, t)),
                                a._emit("pos", d._id)
                            }
                        }
                        return a
                    ...
                    Howl.prototype.orientation = function(e, o, t, r) {
                        ...
                        for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
                            ...
                            if (d) {
                                ...
                                n(d, "spatial")),
                                void 0 !== d._panner.orientationX ? (d._panner.orientationX.setValueAtTime(e, Howler.ctx.currentTime),
                                d._panner.orientationY.setValueAtTime(o, Howler.ctx.currentTime),
                                d._panner.orientationZ.setValueAtTime(t, Howler.ctx.currentTime)) : d._panner.setOrientation(e, o, t)),
                    ...
                    Howl.prototype.pannerAttr = function() {
                        ...
                        if (1 === a.length) {
                            ...
                            e = a[0],
                            void 0 === o && (e.pannerAttr || (e.pannerAttr = {
                        ...
                        for (var i = r._getSoundIds(o), u = 0; u < i.length; u++)
                            if (t = r._soundById(i[u])) {
                                ...
                                s.panningModel = d.panningModel) : (t._pos || (t._pos = r._pos || [0, 0, -.5]),
                                n(t, "spatial"))
                            }
                        return r
                    }
                    ...
                    Sound.prototype.reset = function(e) {
                        return function() {
                            ...
                            n._pos = o._pos,
                            n._pannerAttr = o._pannerAttr,
                            n._stereo ? o.stereo(n._stereo) : n._pos ? o.pos(n._pos[0], n._pos[1], n._pos[2], n._id) : n._panner && (n._panner.disconnect(0),
                            n._panner = void 0,
                            o._refreshBuffer(n)),
                            e.call(this)
                        }
        ...
        return ( () => {
            ...
            const r = (e, ...n) => {
              ...
              , s = () => {
                ...
                null != e.ofx && null != e.ofy && null != e.ofz && null != e.oux && null != e.ouy && null != e.ouz && n().Howler.orientation(e.ofx + o, e.ofy + o, e.ofz + o, e.oux + o, e.ouy + o, e.ouz + o),
            ...
            window.playAmbientMusic = e => {
                ...
                const d = new (n().Howl)({
                    ...
                    html5: !0,
                    onend() {
                        e.loop || (u.ambientMusicPool[o] && (u.ambientMusicPool[o].stop(),
                        delete u.ambientMusicPool[o]),
                        r("sounds.trigger", "onAmbientMusicEnd", o))
                    },
                    onload() {
                        if (!u.ambientMusicPool[o])
                            return delete u.ambientMusicPool[o];
                        if (e.syncAudio > 0) {
                            const n = d.duration()
                        ...
                        d.play(),
                        d.fade(0, e.volume, isNaN(e.fade) ? 2500 : e.fade)
                    }
                });
                d.name = e.sound,
                d.defaultVolume = e.volume,
                u.ambientMusicPool[o] = d
            }
            ,
            window.stopAmbientMusic = e => {
                ...
                if (n) {
                    const o = 2e3;
                    e.force ? (n.stop(),
                    delete u.ambientMusicPool[e.soundId]) : (n.fade(n.defaultVolume, 0, o),
                    n.on("fade", ( () => {
                        n && (n.stop(),
                        delete u.ambientMusicPool[e.soundId])
                    }
                    )))
                }
            }
            ...
            window.playAmbientMusic2 = e => {
                e = JSON.parse(e),
                u.ambientMusic2 && u.ambientMusic2.stop();
                const o = new (n().Howl)({
                    volume: 0,
                    src: a[e.sound] ? [i + a[e.sound]] : [i + e.sound],
                    loop: e.loop,
                ...
                o.name = e.sound,
                o.defaultVolume = e.volume,
                o.play(),
                o.fade(0, e.volume, 2500),
                u.ambientMusic2 = o
            }
            ,
            window.stopAmbientMusic2 = () => {
                u.ambientMusic2 && (u.ambientMusic2.fade(u.ambientMusic2.defaultVolume, 0, 2e3),
                u.ambientMusic2.on("fade", ( () => {
                    u.ambientMusic2 && (u.ambientMusic2.stop(),
                    u.ambientMusic2 = null)
                }
                )))
            }
            ,
            window.stopSound = e => {
                ...
                n && (n.stop(),
                delete u.soundPool[e],
                r("sounds.trigger", "onEnd", e))
            }
            ,
            window.stop2DRadio = () => {
                u.radio2D && (u.radio2D.stop(),
                u.radio2D = null)
            }
            ,
            window.play2DRadio = e => {
                ...
                const o = new (n().Howl)({
                    src: e.url,
                    html5: !0,
                    volume: null != e.volume ? parseFloat(e.volume) : .06,
                    format: ["mp3"],
                    autoplay: !0,
                    onend: () => {
                        u.radio2D = null
            ...
            window.playSound = e => {
                ...
                u.soundPool[o] && (u.soundPool[o].stop(),
                delete u.soundPool[o]);
                const t = new (n().Howl)({
                    volume: null != e.volume ? parseFloat(e.volume) : .25,
                    src: a[e.sound] ? [i + a[e.sound]] : [i + e.sound],
                    loop: e.loop,
                    html5: !0,
                    onend: () => {
                        e.loop || (delete u.soundPool[o],
                        r("sounds.trigger", "onEnd", o))
                    }
                    ,
                    onload() {
                        if (!u.soundPool[o])
                            return delete u.soundPool[o];
                        t.play()
                    }
                });
                u.soundPool[o] = t
            ...
            window.updateAllSoundPos = e => {
                ...
                o && (o.pos(e.sx, e.sy, e.sz),
                n().Howler.pos(e.px, e.py, e.pz),
                n().Howler.orientation(e.ox, e.oy, e.oz, 0, 1, 0))
            }
            ,
            window.updatePlayerSoundPos = e => {
                null != (e = JSON.parse(e)).px && null != e.py && null != e.pz && (d.px = e.px,
                d.py = e.py,
                d.pz = e.pz),
                null != e.ofx && null != e.ofy && null != e.ofz && null != e.oux && null != e.ouy && null != e.ouz && (d.ofx = e.ofx,
                d.ofy = e.ofy,
                d.ofz = e.ofz,
                d.oux = e.oux,
                d.ouy = e.ouy,
